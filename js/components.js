...
class ComponentLoader {
    ...
    <ul class="navbar-list">
        ...
        <li class="navbar-dropdown">
            ...
            <ul class="navbar-dropdown-menu">
                <li><a href="training-basics.html" class="navbar-dropdown-link">📚 Prompting Basics</a></li>
                <li><a href="training-applications.html" class="navbar-dropdown-link">📊 Prompting Applications</a></li>
            </ul>
        </li>
        <li class="navbar-dropdown">
            <a href="resources.html" class="navbar-link navbar-dropdown-toggle" data-page="resources">
                Resources
                <svg class="navbar-dropdown-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" />
                </svg>
            ...
            <ul class="navbar-dropdown-menu">
                <li><a href="template-warehouse.html" class="navbar-dropdown-link">📋 Template Warehouse</a></li>
            </ul>
        </li>
    </ul>
</nav>`,
    ...
    <p class="text-xs">Version 1.3 -- September 27, 2025</p>
</footer>`
    };
